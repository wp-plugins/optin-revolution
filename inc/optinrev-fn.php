  ...
  if ( !function_exists('optinrev_enqueue') ) {
      function optinrev_enqueue( $option ) {
         ...
         case 1:
          ...
          wp_enqueue_style( 'optinrev_css', site_url( '?optinrev-popup=' . $plugin_page ) . '&t=' .  optinrev_cid() );
  ...
  if ( !function_exists( 'optinrev_socials' ) ) {
      ...
      echo '      
          <ul>
              ...
              <li><a href="http://pinterest.com/pin/create/button/?url='.urlencode(OPTINREV_SOCIAL_URL).'&media=https://optinrevolution.com/img/pin.png&description='.OPTINREV_SOCIAL_TITLE.'" title="'.OPTINREV_SOCIAL_TITLE.'" target="_blank" class="pinit"></a></li>
          </ul>
      ';
      }
  }
