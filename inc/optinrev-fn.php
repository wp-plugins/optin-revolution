  ...
  if ( !function_exists('optinrev_enqueue') ) {
      function optinrev_enqueue( $option ) {
         ...
         case 1:
          ...
          wp_enqueue_style( 'optinrev_css', home_url( '?optinrev-popup=' . $plugin_page ) . '&t=' .  optinrev_cid() );
      ...
      function optinrev_mail_providers() {
        ...
        $mailpro = array (
                    ...
                    'icontact' => array (//specialid:{} will pick the listid
                                 'action' => '//app.icontact.com/icp/signup.php',
                    ...
                    'getresponse' => array (
                                 'action' => '//app.getresponse.com/add_contact_webform.html',
                                 'hidden' => 'webform_id',
                                 'text' => 'email',
                                 'input' => 'email,webform_id'
                                ),
                    'mailchimp' => array (
                                 'action' => '//google.us5.list-manage1.com/subscribe/post',
                    ...
                    'virtualsender' => array(
                                'action' => '//www.virtualsender.com/e/a.php/sub/2/vp9v7h',
                                'hidden' => '',
                                'text' => 'email_address',
                                'input' => 'email_address'
                                )
 ...
 if ( !function_exists('optinrev_action_callback') )
 {
     function optinrev_action_callback()
     {
      ...
      if ( isset( $_POST['optinrev_add_image'] ) && $add_img = esc_html($_POST['optinrev_add_image']) )
      {
          ...
          echo json_encode( array('action' => 'success', 'image' => '//' . $_SERVER['HTTP_HOST'] . $imgurl['path'] ) );
          exit();
      }
