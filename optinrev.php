...
$optinrev_installed_version = '1.1.7';
...
by adding video and split testing your popups!
    ...
    <div class="popup-arrow"><img src="{$dir}images/popup-arrow.png"></div>
		<div><a href="http://www.optinrevolution.com/?utm_source=plugin&utm_medium=menu&utm_campaign=upgrade" target="_new" class="button green close"><img src="{$dir}images/tick.png"><span>Yes, I Want More Subscribers Today!</span></a></div><div class="clear"></div>
		<div style="margin-top:8px;text-align:center;"><a href="#" class="close nothank">No thank you, I don't want more subscribers.</a></div>    
	</div>
</div>
