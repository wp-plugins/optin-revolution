...
function optinrev_js()
{
  ...
  $optinrev_isie = optinrev_ie_version();
...
<div class="wrap fform pro-license">
  ...
  <form id="cred_form" name="cred_form" method="post" action="<?php echo $this_uri;?>">
    <?php wp_nonce_field(); ?>
    <div class="row"><label>Email :</label><input type="text" name="amember_email" id="amember_email" size="30" value="<?php echo (count($auth_info))?$auth_info['amember_email']:'';?>"></div>
