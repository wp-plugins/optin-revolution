...
$optinrev_installed_version = '1.1.4';
...
function optinrev_pro_get_started_headline()
{
  ...
  if (  in_array( $plugin_page, array('optinrevolution', 'optinrevolution/optin1', 'optinrevolution/optin-pro-settings') ) ) {
    ...
    echo __('<div class="updated" style="background:none;border:none;"><a href="http://optinrevolution.com/?utm_source=plugin&utm_medium=link&utm_campaign=upgrade" target="_new" id="optinrev-banner">'. optinrev_banner() .'</a></div>');
...
<div class="icon32" id="icon-options-general"><br /></div><?php echo "<h2>" . __( $optin[ $plugin_page ] . ' Settings', 'wotp_trdom' ) . "</h2>"; ?> <br />
  ...
  <form name="optinrev_setup_form" id="optinrev_setup_form" method="POST" action="admin-ajax.php">
    ...
    <input alt="" title="<?php echo $optin[$plugin_page];?> Preview" id="action_preview" type="button" value="Preview" class="optinrev_button" />
    </div>
    <div class="clear"></div>
    </div><br />
    <?php
...
function optinrev_wphead() {
  ...
  function optinrev_mce_before_init( $in )
  {
   ...
   $in['theme_advanced_buttons1']='textedit,|,moveforward,movebackward,|,textbox,|,text_align_left,text_align_center,text_align_justify,text_align_right,|,lineheight,|,input_align_left,input_align_top,|,object_align_top,object_align_bottom,object_align_center,object_align_left,object_align_right,|,undo,redo,ifdragedit,ifdragedithelp';
