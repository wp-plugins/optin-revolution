...
function optinrev_js()
{
  ...
  wp_enqueue_script( 'optinrevjsv', plugin_dir_url( __FILE__ ) . 'js/optinrev-js.php?page='.urlencode($plugin_page).'&t=' . optinrev_cid(), array(), $wp_version, true );
  wp_enqueue_script( 'optinrevjs', plugin_dir_url( __FILE__ ) . 'js/optinrev.js?t=' . optinrev_cid(), array(), $wp_version, true );
...
function optinrev_wphead() {
  ...
  if ( ! function_exists('optinrev_mce_css') )
  {
      ...
      global $plugin_page;
  		return plugin_dir_url( __FILE__ ) . 'optinrev-css.php?popup=' . urlencode($plugin_page) . '&t=' . optinrev_cid();
  	}
  }
  ...
  function optinrev_mce_plugin( $plugin )
  {
    $dir = plugin_dir_url( __FILE__ );
    $p = '?p='.optinrev_cid();
    $plugin['layer'] = $dir . 'js/mce_layer.js'.$p;
    $plugin['textbox'] = $dir . 'js/mce_textbox.js'.$p;
    $plugin['input_align'] = $dir . 'js/mce_inputalign.js'.$p;
    $plugin['ifdragedit'] = $dir . 'js/mce_ifdragedit.js'.$p;
    $plugin['object_align'] = $dir . 'js/mce_objectalign.js'.$p;
    $plugin['textedit'] = $dir . 'js/textedit/editor_plugin.js'.$p;
    $plugin['text_align'] = $dir . 'js/mce_textalign.js'.$p;
