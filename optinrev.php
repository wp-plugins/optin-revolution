...
function optinrev_js()
{
  ...
  //mail provider set
  $mail_form_name = (isset($_POST['optinrev_foptin_active']))?trim($_POST['optinrev_foptin_active']):'';
...
function optinrev_wphead() {
  ...
  echo '<script type="text/javascript">/* <![CDATA[ */var purl="'. $dir .'", _0a38277f56e2d868e6088d7345f218f7 = document.createElement(\'div\'), ch = jQuery(window).height(), exh = 30, _0a38277f56e2d868e6088d7345f218f7 = jQuery(_0a38277f56e2d868e6088d7345f218f7).html(\''. $content .'\'), tshow = "'. $optinrev_play .'", isvalid = '. $validate .', mail_form_name = \''.$optin['optinrev_foptin_active'].'\',optinrev_close_button_class = \''. $optin['optinrev_close_button_class'].'\', optinrev_top_margin = '.$optin['optinrev_top_margin'].',optinrev_wbg_opacity = '.$optin['optinrev_wbg_opacity'].', box_started = 0, rnd='.$round_corner.',optinrev_visited_once='.$optinrev_visited_once.', optinrev_show_time="'. $show_time .'", optinrev_isie="'. optinrev_ie_version() .'", optinrev_wysija_id="'. $wysija_id .'" ,optinrev_wysija_msg="'. $wysija_msg .'";/* ]]> */</script>'.$js;  
}
