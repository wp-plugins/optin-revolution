jQuery(document).ready(function($){            
	$("#optinrev_optin1_enabled").iButton({change: function($input){$.post("admin-ajax.php", {action : "optinrev_action", "optin_popup" : "optinrev_optinrevolution/optin1_enabled", "enabled" : $input.is(":checked")}, function(res){wtfn.msg('Successfully Updated.');});}});
