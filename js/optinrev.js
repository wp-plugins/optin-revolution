...
jQuery(document).ready( function($) {
  ...
  if ( typeof tinymce !== 'undefined' ) {
      if ( tinyMCEPreInit ) {
          tinyMCEPreInit.mceInit.optinrev_excerpt.content_css = wtp + 'optinrev-css.php?popup=' + wtpage;
          tinyMCEPreInit.mceInit.optinrev_excerpt.handle_event_callback = "wtfn.tinymce_event";
          tinyMCEPreInit.mceInit.optinrev_excerpt.setup = "wtfn.tinymce";
      }
  }
