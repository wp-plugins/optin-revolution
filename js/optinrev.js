  ...
  redraw: function()
  {
   var r, wtdom = tinyMCE.activeEditor.dom, rnd = parseInt( j('#optinrev_border_radius').val() ), apc = true;
  ...
  pwt =( wtfn.is_old_ie9() ) ? mn_h : (mn_h + 2) + bw;
 ...
 ie_border_weight: function( e ) {
  ...
  return ( jQuery.browser.msie ) ? ie_bw[ j(e).css('borderLeftWidth') ] : j(e).css('border');
 },
