 ...
 close_button_pos : function( btn_class ) {
  ...
  optin_form_default: function() {        
    if ( typeof tinyMCE.activeEditor != 'undefined' )
    {
      ...
      j(frm).attr( 'action', 'http://www.optinrevolution.com/setup/' );      
      }
    }//tinymce
   },
  ...
  //Text
  if ( /email_address|fields_email|email|ea/.test( el.name.toLowerCase() ) )
  {  
      loc = {left: 10, top: 10};      
      ...
      if ( typeof jQuery( '#optinrev_optin_'+ fcode +' #femail').val() !== 'undefined' )
      vlu = jQuery( '#optinrev_optin_'+ fcode +' #femail').val();      
