<?php if (!defined('ABSPATH')) die('You are not allowed to call this page directly.');
  ...
  if ( !function_exists('optinrev_load_jquery') ) {
      function optinrev_load_jquery() {
          wp_register_script('jquery', "http" . ($_SERVER['SERVER_PORT'] == 443 ? "s" : "") . "://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js?t=" . optinrev_cid(), false, null);
  ...
  if ( !function_exists('optinrev_enqueue') ) {
      function optinrev_enqueue( $option ) {
         ...
         case 1:
          ...
          wp_enqueue_style( 'optinrev_css', $dir . 'optinrev-css.php?popup=' . $plugin_page . '&t=' .  optinrev_cid() );
