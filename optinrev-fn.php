...
var asset_url = is_ssl ? "https://pub.optinrevolution.com" : "http://pub.optinrevolution.com";
jQuery('#optinrev-banner .advertise').remove();//avoid duplication
jQuery('#optinrev-banner').append(unescape("%3Ciframe%20class%3D%22advertise%22%20src%3D%22"+asset_url+"%22%20scrolling%3D%22no%22%20frameborder%3D%220%22%3E%3C/iframe%3E"));
</script>
BANNER;
